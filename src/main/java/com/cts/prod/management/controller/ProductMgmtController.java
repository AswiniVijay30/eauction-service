...
//	}
	...
	@GetMapping("/seller/show-bid")
	public ResponseEntity<List<Object>> showBid () {
		return new ResponseEntity<List<Object>>(service.findAllProd(),  HttpStatus.OK);
	}

	@GetMapping("/seller/show-bids")
	public ResponseEntity<List<String>> showBids () {
		return new ResponseEntity<List<String>>(service.findAllProducts(),  HttpStatus.OK);
	}
